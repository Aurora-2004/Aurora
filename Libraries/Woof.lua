...
function library:CreateTab(name)
  ...
  GlowGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, color3_fromrgb(52, 62, 72)), ColorSequenceKeypoint.new(0.50, color3_fromrgb(255, 255, 255)), ColorSequenceKeypoint.new(1.00, color3_fromrgb(52, 62, 72))}
  ...
  function modules:NewToggle(text, flag, enabled, callback)
    ...
    OffGrad.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, color3_fromrgb(255, 83, 83)), ColorSequenceKeypoint.new(0.15, color3_fromrgb(255, 83, 83)), ColorSequenceKeypoint.new(0.62, color3_fromrgb(52, 62, 72)), ColorSequenceKeypoint.new(1.00, color3_fromrgb(52, 62, 72))}
    ...
    OnGrad.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, color3_fromrgb(52, 62, 72)), ColorSequenceKeypoint.new(0.38, color3_fromrgb(48, 57, 67)), ColorSequenceKeypoint.new(1.00, color3_fromrgb(53, 255, 134))}
    OnGrad.Rotation = 300
    OnGrad.Name = "OnGrad"
    ...
    if enabled then library.flags[flag or text]:SetState(enabled) end
  end
